...
# Chapter 39: The Hermes Reasoning Loop
...
By [Chapter 38](38-gpu-instances.md) you have every **subsystem** required for intelligence:
...
- Monitoring and logging expose behavior ([Chapters 33–34](../part-v-infrastructure/33-monitoring.md))
...
- [Chapters 34–37](35-running-hermes.md) — Hermes lab stack, Qdrant, llama-server, optional GPU path
- [Chapter 27](../part-iv-kubernetes/27-configuration-configmaps-secrets.md) — ConfigMaps/Secrets in prompts
- [Chapters 33–34](../part-v-infrastructure/33-monitoring.md) — observability substrate
...
| **Secrets Manager → K8s Secret** | Tool API keys | Injected at runtime ([Ch 32](../part-v-infrastructure/32-secrets-management.md)) |

### Inference Routing ([Chapter 38](38-gpu-instances.md))
...
| Qdrant | Similar past queries, tool outputs ([Ch 36](36-vector-databases.md)) |
| ConfigMap | Model parameters, feature flags ([Ch 27](../part-iv-kubernetes/27-configuration-configmaps-secrets.md)) |
...
Each cycle emits ([Ch 33–34](../part-v-infrastructure/33-monitoring.md)):
...
| Secrets (Ch 32) | Tool credentials without Git exposure |
| Monitoring + Logging (Ch 33–34) | See the loop under load |
| Postgres / Redis / Qdrant (Ch 35–36) | Active participants in context |
| llama.cpp (Ch 37–38) | One service in the graph—not "the AI" |
...
[Chapter 40: Distributed Cognitive Execution](../part-vii-hermes/40-distributed-cognitive-execution.md) — Hermes as OS for agents; coordinator + shared state.

---

[← Chapter 38: GPU Instances](38-gpu-instances.md) | [Next: Chapter 40 — Distributed Cognitive Execution →](../part-vii-hermes/40-distributed-cognitive-execution.md)
