...
Chapter 29 (Terraform) →  same specification, reproducible
```
...
| `aws_subnet` | `hermes-public-use1a` `10.0.1.0/24` |
...
aws ec2 describe-subnets --filters "Name=tag:Name,Values=hermes-public-use1a" \
...
[Chapter 30: GitHub Actions](30-github-actions.md) — CI/CD that runs `terraform plan` on every change.

Production-grade secrets beyond K8s Secrets: [Chapter 31: Secrets Management](31-secrets-management.md).

---

[← Chapter 28: Scaling](../part-iv-kubernetes/28-scaling.md) | [Next: Chapter 30 — GitHub Actions →](30-github-actions.md)
