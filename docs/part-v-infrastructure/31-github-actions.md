...
[Chapter 30](30-terraform.md) made infrastructure **declarative**. This chapter makes infrastructure changes **event-driven**.
...
- [Chapter 30](30-terraform.md) complete (network module applied locally at least once)
...
Region is set in the workflow (`us-west-2`)—same as [Chapter 8](../part-ii-aws/08-creating-network-for-hermes.md).

:::warning[Never commit credentials]

Keys in Git history are permanent exposure. Use Secrets only. [Chapter 32](32-secrets-management.md) covers external vaults and rotation.
...
Local ([Chapter 30](30-terraform.md)) uses AWS profile `hermes`:
...
**Credential exposure** — Keys in Git, logs, or fork PRs. Use Secrets; restrict fork workflows; prefer OIDC over long-lived keys ([Chapter 32](32-secrets-management.md)).
...
- [Chapter 30: Terraform](30-terraform.md)
...
[Chapter 32: Secrets Management](32-secrets-management.md) — external secret stores, rotation, and auditability beyond Kubernetes Secrets ([Chapter 27](../part-iv-kubernetes/27-configuration-configmaps-secrets.md)).

---

[← Chapter 30: Terraform](30-terraform.md) | [Next: Chapter 32 — Secrets Management →](32-secrets-management.md)
