...
# Chapter 45: The Platform You Built
...
No labs. No YAML. No new commands. [Chapters 1–43](44-from-development-to-production.md) built the machine. **Chapter 45 explains why it works.**
...
[Chapter 17](../part-iii-containers/17-docker.md) did not replace Linux. It **hid** operating-system detail so you could ship reproducible units of work.

### Kubernetes

**Desired state** becomes manifests. **Pods** execute. The **control plane** coordinates. **Metrics and events** describe reality.

[Chapter 13](../part-ii-aws/13-the-first-control-plane.md) gave you k3s. [Part IV](../part-iv-kubernetes/22-deployments.md) gave you the objects. The pattern was unchanged—only the scale.
...
[Chapter 30](../part-v-infrastructure/30-terraform.md) made the pattern explicit: declare what should exist; reconcile reality toward it.
...
[Chapter 39](../part-vi-ai/39-ai-agent-architecture.md) was not magic—it was the same four ideas applied to **cognitive work**: durable tasks, mediated execution, platform-owned coordination, full audit trail.
...
That is the difference between building an application and building a **platform**—the subject of [Chapter 43](43-extending-hermes.md) and [Chapter 44](44-from-development-to-production.md).
...
Ingress terminates HTTP ([Chapter 24](../part-iv-kubernetes/24-ingress.md)). Workers mediate tools ([Chapters 38, 41](../part-vi-ai/39-ai-agent-architecture.md)). Postgres survives Pod restarts ([Chapters 11, 34](../part-vi-ai/35-running-hermes.md)). Qdrant holds meaning ([Chapter 36](../part-vi-ai/36-vector-databases.md)). The model proposes; the platform authorizes ([Chapter 42](42-platform-governance.md)). Git declares; Actions and Terraform reconcile ([Chapters 29–30](../part-v-infrastructure/30-terraform.md)).
...
Those ideas survive individual products. [Chapter 42](42-platform-governance.md) stated it plainly: **the language model is never the security boundary. The platform is.** That principle outlives any model vendor.
...
- GPU node pools ([Chapter 38](../part-vi-ai/38-gpu-instances.md) previewed this)
...
Notice: **none of those require abandoning the architecture you built.** They extend it—new capabilities ([Chapter 43](43-extending-hermes.md)), same platform kernel.
...
Abstraction is not about making systems mysterious. It is about making **complexity manageable**—so you can operate change safely ([Chapter 41](41-operating-hermes-in-production.md)), govern action responsibly ([Chapter 42](42-platform-governance.md)), and grow capabilities without redesign ([Chapter 43](43-extending-hermes.md)).
...
[← Chapter 44: From Development to Production](44-from-development-to-production.md)
