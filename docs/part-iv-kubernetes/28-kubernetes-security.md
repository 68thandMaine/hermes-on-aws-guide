...
# Chapter 28: Security (RBAC & Network Policies)
...
[Chapter 27](27-configuration-configmaps-secrets.md) externalized configuration and secrets. Now you **restrict capability**: who may call the API, and which Pods may talk to each other.

This is not a new paradigm—it is **capability reduction** on the stack you already operate.

```text
Chapter 27   Config/Secret  →  what the system knows
Chapter 28   RBAC + NetworkPolicy →  who may act and who may connect
```
...
- [Chapter 27: Configuration](27-configuration-configmaps-secrets.md)
- nginx workload with label `app: nginx` (Ch 22–25 or `nginx-demo` Helm release)
...
Chapter 28 practices the mechanics on nginx—not Hermes yet.
...
[Chapter 29: Scaling](29-scaling.md) — control system behavior when demand increases.

---

[← Chapter 27: Configuration](27-configuration-configmaps-secrets.md) | [Next: Chapter 29 — Scaling →](29-scaling.md)
