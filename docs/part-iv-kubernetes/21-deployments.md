...
In [Chapter 20](20-pods.md) you created a **Pod**—a one-shot execution unit.
...
```text
Chapter 20   Pod        →  “run this once”
Chapter 21   Deployment →  “always keep N of these running”
```
...
- [ ] Contrast imperative Pod creation (Ch 20) with declarative Deployment manifests
...
- [Chapter 20: Pods](20-pods.md) — bare Pod created and deleted
...
| | Chapter 20 Pod | Chapter 21 Deployment |
|---|----------------|------------------------|
...
**[infrastructure/kubernetes/ch21-nginx-deployment.yaml](https://github.com/crudnicky/agent-to-aws-guide/blob/main/infrastructure/kubernetes/ch21-nginx-deployment.yaml)**
...
1. Apply `ch21-nginx-deployment.yaml`
...
4. How is `kubectl apply` different from `kubectl run` in Chapter 20?
...
- **Pod** = runtime unit you ran once in Ch 20; **Deployment** = desired state for many Pods
...
- Next: [Services](22-services.md)—stable network identity over Pod IPs that change
...
[Chapter 22: Services](22-services.md) — stop targeting Pod IPs directly; expose a stable cluster address for workloads that come and go.

---

[← Chapter 20: Pods](20-pods.md) | [Next: Chapter 22 — Services →](22-services.md)
