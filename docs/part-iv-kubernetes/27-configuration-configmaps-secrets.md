...
# Chapter 27: Configuration (ConfigMaps & Secrets)
...
Helm packages systems ([Chapter 26](26-helm.md)). Before RBAC and network policy, you need something worth protecting: **runtime configuration** decoupled from images and YAML hardcoding.
...
```text
Chapter 26   Helm        →  install the system
Chapter 27   Config/Secret →  parameterize the system
Chapter 28   Security    →  who may change what
```
...
- [Chapter 26: Helm](26-helm.md) — Helm installed; optional nginx-demo release
...
Kubernetes Secrets are **base64-encoded by default**, not encrypted in etcd unless you enable encryption at rest. Treat them as **better than plain YAML**, not vault-grade—[Chapter 32](../part-v-infrastructure/32-secrets-management.md) hardens external secret storage later.
...
Helm charts ([Chapter 26](26-helm.md)) often **generate** ConfigMaps and Secrets from `values.yaml`:
...
- Next: [Chapter 28](28-kubernetes-security.md)—RBAC and network policy protect what you configured
...
- [Chapter 32: Secrets Management](../part-v-infrastructure/32-secrets-management.md) — production hardening
...
[Chapter 28: Security](28-kubernetes-security.md) — RBAC and NetworkPolicy: who may access the configuration and workloads you defined.

---

[← Chapter 26: Helm](26-helm.md) | [Next: Chapter 28 — Security →](28-kubernetes-security.md)
