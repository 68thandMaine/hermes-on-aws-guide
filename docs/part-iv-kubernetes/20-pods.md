...
| Approach | This chapter | Chapter 21 |
|----------|--------------|------------|
...
- **Chapter 20 uses the scheduler** from Chapter 13—no second ignition moment
...
- Bare Pods are for learning; [Chapter 21](21-deployments.md) manages Pods as **desired state**
...
- [Chapter 19: Why Kubernetes Exists](19-why-kubernetes-exists.md) — optional theory depth
...
[Chapter 21: Deployments](21-deployments.md) — stop creating Pods by hand; declare how many should run and let the control plane reconcile.

Optional: [Chapter 19: Why Kubernetes Exists](19-why-kubernetes-exists.md) for theory depth without blocking progress.

---

[← Chapter 13: The First Control Plane](../part-ii-aws/13-the-first-control-plane.md) | [Next: Chapter 21 — Deployments →](21-deployments.md)
