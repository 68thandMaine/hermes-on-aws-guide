...
[Chapter 22](22-services.md) gave nginx a stable **in-cluster** address: `nginx-service`.
...
```text
Chapter 22   Service   →  stable internal identity
Chapter 23   Ingress   →  external HTTP entry
```
...
- [Chapter 22: Services](22-services.md) — `nginx-service` and `nginx-deployment` Running
...
|----------|-------------------|
| `kubectl port-forward` | Debug only (Ch 20–22) |
...
Every layer is the stack you have been assembling since Chapter 20.
...
**[infrastructure/kubernetes/ch23-nginx-ingress.yaml](https://github.com/crudnicky/agent-to-aws-guide/blob/main/infrastructure/kubernetes/ch23-nginx-ingress.yaml)**
...
3. Apply `ch23-nginx-ingress.yaml`
...
- TLS and public DNS move to [Chapter 14](../part-ii-aws/14-routing-traffic-to-hermes.md); persistence to [Chapter 24](24-kubernetes-storage.md)
...
[Chapter 24: Storage](24-kubernetes-storage.md) — PostgreSQL and model data need persistence inside a dynamic cluster.

---

[← Chapter 22: Services](22-services.md) | [Next: Chapter 24 — Storage →](24-kubernetes-storage.md)
