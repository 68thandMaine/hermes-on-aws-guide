...
Chapter 24+      →  persisting state (not disposable)
```
...
They work together. Chapter 11 is **disk on the server**; Chapter 24 is **disk attached to workloads** through the API.
...
**[infrastructure/kubernetes/ch24-app-data-pvc.yaml](https://github.com/crudnicky/agent-to-aws-guide/blob/main/infrastructure/kubernetes/ch24-app-data-pvc.yaml)**
...
**[infrastructure/kubernetes/ch24-storage-demo-pod.yaml](https://github.com/crudnicky/agent-to-aws-guide/blob/main/infrastructure/kubernetes/ch24-storage-demo-pod.yaml)**
...
```bash
kubectl apply -f infrastructure/kubernetes/ch24-storage-demo-pod.yaml
...
[Chapter 25: Helm](25-helm.md) — package manifests (Deployments, Services, Ingress, PVCs) into reusable charts before the Hermes stack lands.
...
[← Chapter 23: Ingress](23-ingress.md) | [Next: Chapter 25 — Helm →](25-helm.md)
