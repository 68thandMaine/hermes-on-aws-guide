# Chapter 40 — example runbook (model server high CPU)
# See docs/part-vii-hermes/40-operating-hermes-in-production.md
...
4. **Scale** — If GPU/CPU headroom: increase replicas only when model supports parallel slots (`-np` in Ch 36).
...
- Node saturation → [Chapter 16](../../docs/part-ii-aws/16-managing-platform-costs.md) resize or Ch 37 GPU path.
